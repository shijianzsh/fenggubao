...
BEGIN
  ...
  BEGIN
    ...
    REPEAT
      FETCH c_queue
        INTO c_user_id, c_queue_id, c_open_time, c_created_time, c_updated_time, c_consume_amount, c_consume_amount_old, c_consume_machine_amount, c_mining_amount, c_mining_out_bei;
      IF NOT done
      THEN
        BEGIN
          out_repeat:
