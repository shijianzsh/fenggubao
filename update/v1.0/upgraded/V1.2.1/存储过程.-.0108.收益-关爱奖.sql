ALTER TABLE zc_care_queue
  ADD order_id INT(11) NOT NULL DEFAULT 0 AFTER income_amount;
        ...
        BEGIN
          ...
          BEGIN
            ...
            IF @circulateBai > 0 THEN
              -- 添加明细
              CALL AddAccountRecord(c_user_id, 'goldcoin', 108, @careIncomeAmount * @circulateBai * 0.01,
                                    UNIX_TIMESTAMP(),
