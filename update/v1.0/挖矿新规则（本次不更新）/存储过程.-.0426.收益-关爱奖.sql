...
BEGIN
  ...
  BEGIN
    ...
    IF orderId = 0 THEN
      # 获取挖矿关爱奖比例
      SET @incomeBai = GetSetting('mine_prize_care_agent_bai');
      SET @circulateBai = GetSetting('mine_prize_care_agent_circulate_bai');
      SET @lockBai = GetSetting('mine_prize_care_agent_lock_bai');
    ELSE
    ...
    IF incomeAmount * @incomeBai * 0.01 < 0.5 THEN
      LEAVE out_label;
    END IF;
