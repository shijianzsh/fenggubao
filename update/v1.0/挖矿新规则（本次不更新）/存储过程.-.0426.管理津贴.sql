...
BEGIN
  ...
  BEGIN
    ...
    IF orderId = 0 THEN
      # 获取挖矿管理津贴比例
      SET @subsidy_bai = GetSetting('mine_subsidy_agent_bai');
      SET @circulateBai = GetSetting('mine_subsidy_agent_circulate_bai');
      SET @lockBai = GetSetting('mine_subsidy_agent_lock_bai');
    ELSE
