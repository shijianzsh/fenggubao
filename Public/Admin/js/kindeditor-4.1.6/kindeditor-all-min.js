...
* @licence http://www.kindsoft.net/license.php
*******************************************************************************/
//var keditorUploadPath = self.basePath + 'php/upload_json.php';
var keditorUploadPath = 'http://'+location.host+'/Admin/Ajax/keditorUpload';
...
KindEditor.plugin('flash', function(K) {
	var self = this, name = 'flash', lang = self.lang(name + '.'),
		...
		uploadJson = K.undef(self.uploadJson, keditorUploadPath);
	self.plugin.flash = {
		edit : function() {
			var html = [
